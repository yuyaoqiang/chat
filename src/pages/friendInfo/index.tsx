...
const Home = (props: any) => {
 ...
 const hasFriend = () => {
  let hasFriend = friends.filter((friend: any) => friend.code === userInfo.code)
 ...
 return (
  <div className="my-wrap">
   ...
   <div className="my-top">
    ...
    <div className="user-info-wrap">
     <p>
      ...
      <span>圈子号: {userInfo.partnerCode}</span>
   ...
   <List className="my-list">
    ...
    {
     isFriend && <Button style={{ color: '#16ac15' }} icon={<i className="iconfont icon-liaotian_jihuo" style={{ fontSize: '22px', color: '#16ac15' }}></i>} onClick={() => push({ pathname: '/chat', state: userInfo })}>发消息</Button>
    }
    {
