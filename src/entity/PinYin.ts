...
// 在对象中搜索
function arraySearch(l1:any, l2:any) {
...
export function pySegSort(tarr:any) {
 for (let i = 0; i < tarr.length; i++) {
   let inputV = tarr[i].nickName
   let str = ConvertPinyin(inputV);
   tarr[i].translateName = str
 }
 ...
 if (res.segs[0] && res.segs[0].initial == '*') {
